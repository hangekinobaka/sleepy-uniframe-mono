...
//    /// </summary>
//    internal class SceneDirectorTestScript : MonoBehaviour
//    {
//        [SerializeField] float _delay = 8f;
//        [SerializeField] TextMeshProUGUI countdownTextUI;
...
//            controller.RemainingTime.State.Subscribe(val =>
//            {
//                countdownTextUI.text = val.ToString();
//            }).AddTo(this);
